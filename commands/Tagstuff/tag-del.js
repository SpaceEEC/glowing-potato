  ...
  if (!(
    ...
    return bot.internal.tag.remove(bot, msg.guild.id, params.join(' ').toLowerCase())
      ...
      .catch((e) => {
        ...
        msg.channel.sendMessage('Es ist ein interner Fehler beim Löschen dieses Tags aufgetreten. (Es kann sein, dass der Tag nur temporär gelöscht worden ist.\n\nFalls der Tag nach einen Neustart wieder da ist kontaktiere bitte `spaceeec#0302`)');
      });
  } else {
