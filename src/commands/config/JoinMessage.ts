...
export default class JoinMessageCommand extends Command<Client>
{
	...
	{
		return GuildConfigUtil[option](message, GuildConfigStrings.JOINMESSAGE, GuildConfigType.STRING, value);
	}
}
